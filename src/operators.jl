...
```
"""
function SpectralConv(transform::T, ch::Pair{S,S}; init = Flux.glorot_uniform) where {T,S<:Int}
...
function Base.show(io::IO, sc::SpectralConv)
    print(io, "SpectralConv($(sc.in_channels) => $(sc.out_channels), $(sc.transform))")
end
...
# Utils
tensor_contraction(A, B, ::Val{1}) = @tullio C[o, a, b] := A[i, a, o] * B[i, a, b]
tensor_contraction(A, B, ::Val{2}) = @tullio C[o, a₁, a₂, b] := A[i, a₁, a₂, o] * B[i, a₁, a₂, b]
tensor_contraction(A, B, ::Val{3}) = @tullio C[o, a₁, a₂, a₃, b] := A[i, a₁, a₂, a₃, o] * B[i, a₁, a₂, a₃, b]
tensor_contraction(A, B, ::Val{4}) = @tullio C[o, a₁, a₂, a₃, a₄, b] := A[i, a₁, a₂, a₃, a₄, o] * B[i, a₁, a₂, a₃, a₄, b]
